...
if __name__ == '__main__':
    ...
    print ('Occurance #', most_frequent_word(hist) [1])

    #part3
    hist = build_histogram('two_cities.txt')
    print ('Words with frequrncy of one', words_with_frequency(hist,1))

    hist = build_histogram('sons_of_martha.txt')
    print ('Words with frequrncy of five', words_with_frequency(hist,5))
